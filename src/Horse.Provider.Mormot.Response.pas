...
begin
  ...
  // TStringList on FPC but TDictionary<string,string> on Delphi — Names[I]/
  // ValueFromIndex[I] only exist on FPC. Split per compiler (was E2003 'Names'
  // building the mORMot provider against merged horse).
